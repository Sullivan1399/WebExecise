		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 additional-nav">
				<ul class="list-unstyled list-inline pull-right">
					<li><a href="${pageContext.request.contextPath}/updateprofile">My Account</a></li>
					...
					<li>
						<c:choose>
							...
							<c:otherwise>
								<a href="${pageContext.request.contextPath}/admin/home">${sessionScope.account.username}</a>
